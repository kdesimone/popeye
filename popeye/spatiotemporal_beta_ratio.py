...
class SpatioTemporalModel(PopulationModel):
    ...
    def generate_ballpark_prediction(self, x, y, sigma, beta, beta_ratio, baseline, hrf_delay):
        ...
        # mix them
        mp_ts = m_ts * beta + p_ts * beta_ratio/beta
    ...
    # for the final solution, we use spatiotemporal
    def generate_prediction(self, x, y, sigma, beta, beta_ratio, baseline, hrf_delay):
