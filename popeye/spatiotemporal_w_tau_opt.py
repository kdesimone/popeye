...
class SpatioTemporalModel(PopulationModel):
    ...
    def generate_ballpark_prediction(self, x, y, sigma, tau, weight, beta, baseline, hrf_delay):
    ...
    # for the final solution, we use spatiotemporal
    def generate_prediction(self, x, y, sigma, tau, weight, beta, baseline, hrf_delay):
