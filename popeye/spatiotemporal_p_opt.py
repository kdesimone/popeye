...
class SpatioTemporalModel(PopulationModel):
    ...
    def generate_ballpark_prediction(self, x, y, sigma, pbeta, baseline, hrf_delay):
        ...
        mp_ts = generate_strf_betas_timeseries(rf_ts, self.m_resp, self.p_resp, self.stimulus.flicker_vec, self.mbeta, pbeta)
    ...
    # for the final solution, we use spatiotemporal
    def generate_prediction(self, x, y, sigma, pbeta, baseline, hrf_delay):
