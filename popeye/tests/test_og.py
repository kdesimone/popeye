...
def test_og_fit():
    ...
    # assert equivalence
    nt.assert_almost_equal(fit.x_, x)
    nt.assert_almost_equal(fit.y_, y)
    nt.assert_almost_equal(fit.sigma_, sigma)
    nt.assert_almost_equal(fit.beta_, beta)
    nt.assert_almost_equal(fit.hrf_delay_, hrf_delay)
