...
def test_strf_2dcos_fit():
    ...
    # coarse fit
    npt.assert_almost_equal((fit.x0,fit.y0,fit.s0,fit.w0,fit.beta0,fit.baseline0),(-0.5, 3.25, 3.0, 0.49999999999999994, 1.0000000000000002, -0.010826240688006666),2)
