...
class SpatioTemporalModel(PopulationModel):
    ...
    def generate_ballpark_prediction(self, x, y, sigma, n, weight, beta, baseline):
...
class SpatioTemporalFit(PopulationFit):
    ...
    def overloaded_estimate(self):
        return [self.theta, self.rho, self.sigma_size, self.n, self.weight, self.beta, self.baseline]
