...
class SpatioTemporalModel(PopulationModel):
    ...
    def generate_ballpark_prediction(self, x, y, sigma, n, mbeta, pbeta):
    ...
    # for the final solution, we use spatiotemporal
    def generate_prediction(self, x, y, sigma, n, mbeta, pbeta):
...
class SpatioTemporalFit(PopulationFit):
    ...
    def overloaded_estimate(self):
        return [self.theta, self.rho, self.sigma_size, self.weight]
